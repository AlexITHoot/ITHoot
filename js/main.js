...
/* harmony export */   "P": function() { return /* binding */ wi; },
/* harmony export */   "S": function() { return /* binding */ I; }
/* harmony export */ });
function Z(t) {
	...
	for (let d = 0; d < this.length; d += 1) {
		...
		if (i)
			for (l = 0; l < o.length; l += 1) {
				const f = o[l];
				c.dom7LiveListeners || (c.dom7LiveListeners = {}), c.dom7LiveListeners[f] || (c.dom7LiveListeners[f] = []), c.dom7LiveListeners[f].push({ listener: s, proxyListener: n }), c.addEventListener(f, n, r);
			}
		else
			for (l = 0; l < o.length; l += 1) {
				const f = o[l];
				c.dom7Listeners || (c.dom7Listeners = {}), c.dom7Listeners[f] || (c.dom7Listeners[f] = []), c.dom7Listeners[f].push({ listener: s, proxyListener: a }), c.addEventListener(f, a, r);
			}
	}
	return this;
}
			...
			if ((!i && d.dom7Listeners ? (c = d.dom7Listeners[o]) : i && d.dom7LiveListeners && (c = d.dom7LiveListeners[o]), c && c.length))
				for (let f = c.length - 1; f >= 0; f -= 1) {
					...
					(s && p.listener === s) || (s && p.listener && p.listener.dom7proxy && p.listener.dom7proxy === s)
						...
						: s || (d.removeEventListener(o, p.proxyListener, r), c.splice(f, 1));
				}
		}
	}
	return this;
...
function Le(...t) {
	...
	for (let r = 0; r < i.length; r += 1) {
		...
		for (let a = 0; a < this.length; a += 1) {
			const o = this[a];
			if (e.CustomEvent) {
				const l = new e.CustomEvent(n, { detail: s, bubbles: !0, cancelable: !0 });
...
function De(t, e) {
	...
	if (arguments.length === 1)
		if (typeof t == "string") {
			...
			for (s = 0; s < this.length; s += 1) for (const r in t) this[s].style[r] = t[r];
			return this;
		}
...
function Ve(t) {
	...
	if (t.nodeType || t instanceof A) {
		for (r = t.nodeType ? [t] : t, n = 0; n < r.length; n += 1) if (r[n] === s) return !0;
		return !1;
	}
	return !1;
}
...
function Re(...t) {
	...
	for (let s = 0; s < t.length; s += 1) {
		...
		for (let r = 0; r < this.length; r += 1)
			...
			} else if (e instanceof A) for (let n = 0; n < e.length; n += 1) this[r].appendChild(e[n]);
...
function We(t) {
	...
	for (i = 0; i < this.length; i += 1)
		...
		} else if (t instanceof A) for (s = 0; s < t.length; s += 1) this[i].insertBefore(t[s], this[i].childNodes[0]);
...
function at(t) {
	...
	return (
		!c && u && i.touch && h.indexOf(`${o}x${l}`) >= 0 && ((c = n.match(/(Version)\/([\d.]+)/)), c || (c = [0, 1, "13_0_0"]), (u = !1)),
...
function ft(t) {
	...
	const n = [],
		...
		o = function (c, f) {
			...
			v.observe(c, { attributes: typeof f.attributes == "undefined" ? !0 : f.attributes, childList: typeof f.childList == "undefined" ? !0 : f.childList, characterData: typeof f.characterData == "undefined" ? !0 : f.characterData }),
				n.push(v);
		},
		l = () => {
	...
	i({ observer: !1, observeParents: !1, observeSlideChildren: !1 }), s("init", l), s("destroy", d);
}
var ut = {
	on(t, e, i) {
		const s = this;
...
function pt() {
	...
	let e, i;
	const s = t.$el;
	typeof t.params.width != "undefined" && t.params.width !== null ? (e = t.params.width) : (e = s[0].clientWidth),
		typeof t.params.height != "undefined" && t.params.height !== null ? (i = t.params.height) : (i = s[0].clientHeight),
...
function ht() {
	...
	typeof C == "string" && C.indexOf("%") >= 0 && (C = (parseFloat(C.replace("%", "")) / 100) * n),
		(t.virtualSize = -C),
			...
			c[b] && (c[b].swiperSlideSize = E),
				...
				s.centeredSlides
					? ((T = T + E / 2 + M / 2 + C),
						...
						v.push(T))
					: (s.roundLengths && (T = Math.floor(T)), (P - Math.min(t.params.slidesPerGroupSkip, P)) % t.params.slidesPerGroup == 0 && p.push(T), v.push(T), (T = T + E + C)),
				(t.virtualSize += E + C),
				(M = E),
				(P += 1);
		}
	...
	if (
		((t.virtualSize = Math.max(t.virtualSize, n) + S),
			a && o && (s.effect === "slide" || s.effect === "coverflow") && r.css({ width: `${t.virtualSize + s.spaceBetween}px` }),
			s.setWrapperSize && r.css({ [e("width")]: `${t.virtualSize + s.spaceBetween}px` }),
	...
	if ((p.length === 0 && (p = [0]), s.spaceBetween !== 0)) {
		...
		c.filter((y, x) => (s.cssMode ? x !== c.length - 1 : !0)).css({ [b]: `${C}px` });
	}
	...
	if ((Object.assign(t, { slides: c, snapGrid: p, slidesGrid: v, slidesSizesGrid: u }), s.centeredSlides && s.cssMode && !s.centeredSlidesBounds)) {
...
function vt(t) {
	...
	for (let o = 0; o < s.length; o += 1) {
		...
		((p >= 0 && p < e.size - 1) || (v > 1 && v <= e.size) || (p <= 0 && v >= e.size)) && (e.visibleSlides.push(l), e.visibleSlidesIndexes.push(o), s.eq(o).addClass(i.slideVisibleClass)),
			(l.progress = r ? -c : c),
...
function wt(t) {
	...
	const o = n,
		l = a;
	s === 0 ? ((r = 0), (n = !0), (a = !0)) : ((r = (t - e.minTranslate()) / s), (n = r <= 0), (a = r >= 1)),
...
function St() {
	...
	let o;
	a ? (o = t.$wrapperEl.find(`.${i.slideClass}[data-swiper-slide-index="${r}"]`)) : (o = e.eq(r)),
...
function Tt(t) {
	const e = this,
		...
		{ slidesGrid: s, snapGrid: r, params: n, activeIndex: a, realIndex: o, snapIndex: l } = e;
	let d = t,
		c;
	...
	Object.assign(e, { snapIndex: c, realIndex: f, previousIndex: a, activeIndex: d }),
...
var Ct = { updateSize: pt, updateSlides: ht, updateAutoHeight: mt, updateSlidesOffset: gt, updateSlidesProgress: vt, updateProgress: wt, updateSlidesClasses: St, updateActiveIndex: Tt, updateClickedSlide: bt };
function yt(t) {
...
function xt(t, e) {
	const i = this,
		{ rtlTranslate: s, params: r, $wrapperEl: n, wrapperEl: a, progress: o } = i;
	let l = 0,
		d = 0;
	const c = 0;
	i.isHorizontal() ? (l = s ? -t : t) : (d = t),
		r.roundLengths && ((l = Math.floor(l)), (d = Math.floor(d))),
		r.cssMode ? (a[i.isHorizontal() ? "scrollLeft" : "scrollTop"] = i.isHorizontal() ? -l : -d) : r.virtualTranslate || n.transform(`translate3d(${l}px, ${d}px, ${c}px)`),
...
function Pt(t, e, i, s, r) {
	...
	if ((s && t > l ? (c = l) : s && t < d ? (c = d) : (c = t), n.updateProgress(c), a.cssMode)) {
		...
		if (e === 0) o[f ? "scrollLeft" : "scrollTop"] = -c;
			...
			if (!n.support.smoothScroll) return se({ swiper: n, targetPosition: -c, side: f ? "left" : "top" }), !0;
...
var $t = { getTranslate: yt, setTranslate: xt, minTranslate: Et, maxTranslate: Mt, translateTo: Pt };
function Lt(t, e) {
	const i = this;
...
function Ot(t, e) {
	...
	const i = this,
		{ params: s } = i;
	s.cssMode || (s.autoHeight && i.updateAutoHeight(), re({ swiper: i, runCallbacks: t, direction: e, step: "Start" }));
}
function kt(t, e) {
	t === void 0 && (t = !0);
	const i = this,
		{ params: s } = i;
	(i.animating = !1), !s.cssMode && (i.setTransition(0), re({ swiper: i, runCallbacks: t, direction: e, step: "End" }));
}
var It = { setTransition: Lt, transitionStart: Ot, transitionEnd: kt };
function zt(t, e, i, s, r) {
	if ((t === void 0 && (t = 0), e === void 0 && (e = this.params.speed), i === void 0 && (i = !0), typeof t != "number" && typeof t != "string"))
	...
	let a = t;
	a < 0 && (a = 0);
	const { params: o, snapGrid: l, slidesGrid: d, previousIndex: c, activeIndex: f, rtlTranslate: p, wrapperEl: v, enabled: u } = n;
	...
	let m;
	if ((a > f ? (m = "next") : a < f ? (m = "prev") : (m = "reset"), (p && -w === n.translate) || (!p && w === n.translate)))
		return n.updateActiveIndex(a), o.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), o.effect !== "slide" && n.setTranslate(w), m !== "reset" && (n.transitionStart(i, m), n.transitionEnd(i, m)), !1;
	if (o.cssMode) {
		...
		if (e === 0) {
			...
			if (!n.support.smoothScroll) return se({ swiper: n, targetPosition: T, side: C ? "left" : "top" }), !0;
...
function Gt(t, e, i) {
	t === void 0 && (t = this.params.speed), e === void 0 && (e = !0);
	const s = this,
		{ params: r, animating: n, snapGrid: a, slidesGrid: o, rtlTranslate: l, enabled: d } = s;
	if (!d) return s;
	if (r.loop) {
	...
	if (
		(typeof u != "undefined" &&
			((h = o.indexOf(u)), h < 0 && (h = s.activeIndex - 1), r.slidesPerView === "auto" && r.slidesPerGroup === 1 && r.slidesPerGroupAuto && ((h = h - s.slidesPerViewDynamic("previous", !0) + 1), (h = Math.max(h, 0)))),
		...
		(n = parseInt(g(t.clickedSlide).attr("data-swiper-slide-index"), 10)),
			e.centeredSlides
				? r < t.loopedSlides - s / 2 || r > t.slides.length - t.loopedSlides + s / 2
					? (t.loopFix(),
						(r = i.children(`.${e.slideClass}[data-swiper-slide-index="${n}"]:not(.${e.slideDuplicateClass})`).eq(0).index()),
						R(() => {
							t.slideTo(r);
						}))
					: t.slideTo(r)
...
var Vt = { slideTo: zt, slideToLoop: At, slideNext: Dt, slidePrev: Gt, slideReset: Bt, slideToClosest: Nt, slideToClickedSlide: Ht };
function Ft() {
	const t = this,
		e = L(),
...
function _t() {
	...
	const { activeIndex: e, slides: i, loopedSlides: s, allowSlidePrev: r, allowSlideNext: n, snapGrid: a, rtlTranslate: o } = t;
	let l;
	(t.allowSlidePrev = !0), (t.allowSlideNext = !0);
	const c = -a[e] - t.getTranslate();
	e < s
		? ((l = i.length - s * 3 + e), (l += s), t.slideTo(l, 0, !1, !0) && c !== 0 && t.setTranslate((o ? -t.translate : t.translate) - c))
		: e >= i.length - s && ((l = -i.length + e + s), (l += s), t.slideTo(l, 0, !1, !0) && c !== 0 && t.setTranslate((o ? -t.translate : t.translate) - c)),
		(t.allowSlidePrev = r),
		(t.allowSlideNext = n),
		t.emit("loopFix");
}
...
function Kt(t) {
	...
	if (
		...
		((r.isTouchEvent = l.type === "touchstart"), !r.isTouchEvent && "which" in l && l.which === 3) ||
...
function Ut(t) {
	...
	if (!i.allowTouchMove) {
		g(l.target).is(s.focusableElements) || (i.allowClick = !1), s.isTouched && (Object.assign(n, { startX: c, startY: f, currentX: c, currentY: f }), (s.touchStartTime = N()));
		return;
	}
	...
	if (typeof s.isScrolling == "undefined") {
		...
		(i.isHorizontal() && n.currentY === n.startY) || (i.isVertical() && n.currentX === n.startX)
			? (s.isScrolling = !1)
			: p * p + v * v >= 25 && ((w = (Math.atan2(Math.abs(v), Math.abs(p)) * 180) / Math.PI), (s.isScrolling = i.isHorizontal() ? w > r.touchAngle : 90 - w > r.touchAngle));
	}
	...
	if (
		(r.touchReleaseOnEdges && (S = 0),
			u > 0 && s.currentTranslate > i.minTranslate()
				? ((h = !1), r.resistance && (s.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + s.startTranslate + u) ** S))
				: u < 0 && s.currentTranslate < i.maxTranslate() && ((h = !1), r.resistance && (s.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - s.startTranslate - u) ** S)),
...
function Jt(t) {
	...
	if (c > s.longSwipesMs) {
		...
		e.swipeDirection === "next" && (S >= s.longSwipesRatio ? e.slideTo(s.rewind && e.isEnd ? u : p + w) : e.slideTo(p)),
			e.swipeDirection === "prev" && (S > 1 - s.longSwipesRatio ? e.slideTo(p + w) : h !== null && S < 0 && Math.abs(S) > s.longSwipesRatio ? e.slideTo(h) : e.slideTo(p));
	} else {
		if (!s.shortSwipes) {
			e.slideTo(e.activeIndex);
			return;
		...
		e.navigation && (l.target === e.navigation.nextEl || l.target === e.navigation.prevEl)
			? l.target === e.navigation.nextEl
				? e.slideTo(p + w)
				: e.slideTo(p)
			: (e.swipeDirection === "next" && e.slideTo(u !== null ? u : p + w), e.swipeDirection === "prev" && e.slideTo(h !== null ? h : p));
	}
}
function ae() {
	const t = this,
	...
	(t.allowSlideNext = !0),
		...
		(e.slidesPerView === "auto" || e.slidesPerView > 1) && t.isEnd && !t.isBeginning && !t.params.centeredSlides ? t.slideTo(t.slides.length - 1, 0, !1, !0) : t.slideTo(t.activeIndex, 0, !1, !0),
...
const oe = (t, e) => {
	const i = L(),
		{ params: s, touchEvents: r, el: n, wrapperEl: a, device: o, support: l } = t,
		d = !!s.nested,
	...
	if (!l.touch) n[c](r.start, t.onTouchStart, !1), i[c](r.move, t.onTouchMove, d), i[c](r.end, t.onTouchEnd, !1);
		...
		const p = r.start === "touchstart" && l.passiveListener && s.passiveListeners ? { passive: !0, capture: !1 } : !1;
		n[c](r.start, t.onTouchStart, p), n[c](r.move, t.onTouchMove, l.passiveListener ? { passive: !1, capture: d } : d), n[c](r.end, t.onTouchEnd, p), r.cancel && n[c](r.cancel, t.onTouchEnd, p);
	}
	(s.preventClicks || s.preventClicksPropagation) && n[c]("click", t.onClick, !0),
		s.cssMode && a[c]("scroll", t.onScroll),
		s.updateOnWindowResize ? t[f](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", ae, !0) : t[f]("observerUpdate", ae, !0);
};
function ti() {
	const t = this,
		e = L(),
...
function ni() {
	const t = this,
		{ activeIndex: e, initialized: i, loopedSlides: s = 0, params: r, $el: n } = t,
		a = r.breakpoints;
	...
	const d = (o in a ? a[o] : void 0) || t.originalParams,
		...
		p = r.enabled;
	c && !f
		? (n.removeClass(`${r.containerModifierClass}grid ${r.containerModifierClass}grid-column`), t.emitContainerClasses())
		: !c &&
		f &&
		(n.addClass(`${r.containerModifierClass}grid`), ((d.grid.fill && d.grid.fill === "column") || (!d.grid.fill && r.grid.fill === "column")) && n.addClass(`${r.containerModifierClass}grid-column`), t.emitContainerClasses());
	...
	Object.assign(t, { allowTouchMove: t.params.allowTouchMove, allowSlideNext: t.params.allowSlideNext, allowSlidePrev: t.params.allowSlidePrev }),
		...
		u && i && (t.loopDestroy(), t.loopCreate(), t.updateSlides(), t.slideTo(e - s + t.loopedSlides, 0, !1)),
		t.emit("breakpoint", d);
}
function ri(t, e, i) {
...
function gi(t, e) {
	return function (s) {
		...
		if ((["navigation", "pagination", "scrollbar"].indexOf(r) >= 0 && t[r] === !0 && (t[r] = { auto: !0 }), !(r in t && "enabled" in n))) {
			O(e, s);
			return;
		}
		t[r] === !0 && (t[r] = { enabled: !0 }), typeof t[r] == "object" && !("enabled" in t[r]) && (t[r].enabled = !0), t[r] || (t[r] = { enabled: !1 }), O(e, s);
	};
}
const X = { eventsEmitter: ut, update: Ct, translate: $t, transition: It, slide: Vt, loop: Wt, grabCursor: Xt, events: si, breakpoints: ai, checkOverflow: mi, classes: ci, images: pi },
	Y = {};
class I {
	constructor() {
		let e, i;
		...
		const o = {};
		a.modules.forEach((d) => {
			d({ swiper: a, extendParams: gi(i, o), on: a.on.bind(a), once: a.once.bind(a), off: a.off.bind(a), emit: a.emit.bind(a) });
		});
		const l = O({}, ce, o);
		return (
			(a.params = O({}, l, Y, i)),
	...
	slidesPerViewDynamic(e, i) {
		...
		const s = this,
			{ params: r, slides: n, slidesGrid: a, slidesSizesGrid: o, size: l, activeIndex: d } = s;
		let c = 1;
		if (r.centeredSlides) {
		...
		} else if (e === "current") for (let f = d + 1; f < n.length; f += 1) (i ? a[f] + o[f] - a[d] < l : a[f] - a[d] < l) && (c += 1);
	...
	update() {
		...
		e.params.freeMode && e.params.freeMode.enabled
			...
			: ((e.params.slidesPerView === "auto" || e.params.slidesPerView > 1) && e.isEnd && !e.params.centeredSlides ? (n = e.slideTo(e.slides.length - 1, 0, !1, !0)) : (n = e.slideTo(e.activeIndex, 0, !1, !0)), n || r()),
	...
	changeDirection(e, i) {
		...
		return (
			...
			(s.$el.removeClass(`${s.params.containerModifierClass}${r}`).addClass(`${s.params.containerModifierClass}${e}`),
...
function wi(t) {
	...
	function c() {
		...
		if (
			(e.params.loop
				? ((m = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)),
				...
				: typeof e.snapIndex != "undefined"
					? (m = e.snapIndex)
					: (m = e.activeIndex || 0),
				h.type === "bullets" && e.pagination.bullets && e.pagination.bullets.length > 0)
		) {
			...
			if (
				(h.dynamicBullets &&
					((a = T.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0)),
						w.css(e.isHorizontal() ? "width" : "height", `${a * (h.dynamicMainBullets + 4)}px`),
						h.dynamicMainBullets > 1 && e.previousIndex !== void 0 && ((o += m - (e.previousIndex - e.loopedSlides || 0)), o > h.dynamicMainBullets - 1 ? (o = h.dynamicMainBullets - 1) : o < 0 && (o = 0)),
						(M = Math.max(m - o, 0)),
						(P = M + (Math.min(T.length, h.dynamicMainBullets) - 1)),
						(z = (P + M) / 2)),
					T.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((E) => `${h.bulletActiveClass}${E}`).join(" ")),
					w.length > 1)
			)
				T.each((E) => {
					const k = g(E),
		...
		h.type === "custom" && h.renderCustom ? (w.html(h.renderCustom(e, m + 1, C)), r("paginationRender", w[0])) : r("paginationUpdate", w[0]),
			e.params.watchOverflow && e.enabled && w[e.isLocked ? "addClass" : "removeClass"](h.lockClass);
	}
	function f() {
		...
		u.type === "fraction" && (u.renderFraction ? (w = u.renderFraction.call(e, u.currentClass, u.totalClass)) : (w = `<span class="${u.currentClass}"></span> / <span class="${u.totalClass}"></span>`), S.html(w)),
			u.type === "progressbar" && (u.renderProgressbar ? (w = u.renderProgressbar.call(e, u.progressbarFillClass)) : (w = `<span class="${u.progressbarFillClass}"></span>`), S.html(w)),
			u.type !== "custom" && r("paginationRender", e.pagination.$el[0]);
	}
	function p() {
		e.params.pagination = vi(e, e.originalParams.pagination, e.params.pagination, { el: "swiper-pagination" });
		const u = e.params.pagination;
		if (!u.el) return;
		let h = g(u.el);
		h.length !== 0 &&
			(e.params.uniqueNavElements && typeof u.el == "string" && h.length > 1 && ((h = e.$el.find(u.el)), h.length > 1 && (h = h.filter((S) => g(S).parents(".swiper")[0] === e.el))),
				...
				u.type === "bullets" && u.dynamicBullets && (h.addClass(`${u.modifierClass}${u.type}-dynamic`), (o = 0), u.dynamicMainBullets < 1 && (u.dynamicMainBullets = 1)),
				u.type === "progressbar" && u.progressbarOpposite && h.addClass(u.progressbarOppositeClass),
				u.clickable &&
	...
	function v() {
		...
		h.removeClass(u.hiddenClass),
			...
			e.pagination.bullets && e.pagination.bullets.removeClass && e.pagination.bullets.removeClass(u.bulletActiveClass),
...
!function() {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
new _vendor_js__WEBPACK_IMPORTED_MODULE_0__.S(".panorama-slider .swiper", {
	modules: [_vendor_js__WEBPACK_IMPORTED_MODULE_0__.P, S],
	effect: "panorama",
	loop: !0,
	loopedSlides: 10,
	centeredSlides: !0,
